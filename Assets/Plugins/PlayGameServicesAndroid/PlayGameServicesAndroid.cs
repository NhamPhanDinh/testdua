...
public class PlayGameServices
{
	...
	{
		// no-op for this due to the bug: http://prime31.com/support/1852/unlocking-achievement-crushes-application
	}
	...
	public static GPGPlayerInfo getLocalPlayerInfo()
	{
		...
		player.setDataFromJson( _plugin.Call<string>( "getLocalPlayerInfo" ) );
		return player;
	}
	...
	public static List<GPGAchievementMetadata> getAllAchievementMetadata()
	{
		...
		return GPGAchievementMetadata.listFromJson<GPGAchievementMetadata>( json );
	}
	...
	public static List<GPGLeaderboardMetadata> getAllLeaderboardMetadata()
	{
		...
		return GPGLeaderboardMetadata.listFromJson<GPGLeaderboardMetadata>( json );
	}
