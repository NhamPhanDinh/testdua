...
public class tk2dUIDemo5ControllerTest : tk2dUIBaseDemoController
{
		...
		void Start ()
		{
				...
				lastListItem.transform.localPosition = new Vector3 (lastListItem.transform.localPosition.x, y, 0);
				y += (lastListItem.GetMaxBounds () - lastListItem.GetMinBounds ()).y;
				manualScrollableArea.ContentLength = y;
		...
		{
				float y = lastListItem.transform.localPosition.y;
				float w = (prefabItem.GetMaxBounds () - prefabItem.GetMinBounds ()).y;
				...
				for (int i = 0; i < numToAdd; ++i) {
						...
						lastListItem.transform.localPosition = new Vector3 (lastListItem.transform.localPosition.x, y, 0);
						manualScrollableArea.ContentLength = y + (lastListItem.GetMaxBounds () - lastListItem.GetMinBounds ()).y;
